...
-- CreateIndex
CREATE UNIQUE INDEX "Day_day_month_year_userId_key" ON "Day"("day", "month", "year", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "Location_userId_name_key" ON "Location"("userId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "Location_userId_address_key" ON "Location"("userId", "address");
...
-- AddForeignKey
ALTER TABLE "Day" ADD CONSTRAINT "Day_AccomodationId_fkey" FOREIGN KEY ("AccomodationId") REFERENCES "Location"("id") ON DELETE SET NULL ON UPDATE CASCADE;
